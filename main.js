...
function getTodos() {
    ...
    // Below is may be a better way to do this stuff.
    axios
  ...
  // PUT/PATCH REQUEST
  function updateTodo() {
    // if we used put whole data will be replaced.
    // if we used patch only updated data will be updated.
    axios
